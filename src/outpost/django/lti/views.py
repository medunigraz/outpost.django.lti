...
from . import utils
from .models import Consumer, GroupRole, Resource
    ...
    def post(self, request):
        ...
        try:
            consumer = Consumer.objects.get(
                key=tool_provider.consumer_key, enabled=True
            )
        ...
        # import pudb; pu.db
        language = params.get("launch_presentation_locale", settings.LANGUAGE_CODE)
